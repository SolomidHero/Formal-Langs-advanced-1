...
static symbol_t symbols[SYMTABLE_SIZE + 1];     //  name <-> func or variable
char expression_to_parse[EXPR_SIZE + 1];        //  clear expression (no spaces, assignments)
...
static void
read_input(size_t sym_start_offset, FILE* istream)
{    
	char buffer[128];
